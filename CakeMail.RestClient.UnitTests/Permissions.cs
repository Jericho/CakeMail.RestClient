...
namespace CakeMail.RestClient.UnitTests
{
	...
	public class PermissionsTests
	{
		...
		[TestMethod]
		public void SetPermissions_with_minimal_parameters()
		{
			// Arrange
			var userId = 1234;
		...
		[TestMethod]
		public void SetPermissions_with_customerid()
		{
			// Arrange
			var userId = 1234;
			var permissions = new string[] { "FirstPermission", "SecondPermission", "ThirdPermission" }; ;
		...
		[TestMethod]
		public void GetPermissions_with_minimal_parameters()
		{
			// Arrange
			var userId = 1234;
		...
		[TestMethod]
		public void GetPermissions_with_clientid()
		{
			// Arrange
			var userId = 1234;
