...
namespace CakeMail.RestClient.Resources
{
	...
	public interface ITemplates
	{
		...
		Task<long> CreateAsync(string userKey, IDictionary<string, string> labels, string content, long categoryId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<long> CreateCategoryAsync(string userKey, IDictionary<string, string> labels, bool isVisibleByDefault = true, bool templatesCanBeCopied = true, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> DeleteAsync(string userKey, long templateId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> DeleteCategoryAsync(string userKey, long categoryId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<Template> GetAsync(string userKey, long templateId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<TemplateCategory[]> GetCategoriesAsync(string userKey, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<long> GetCategoriesCountAsync(string userKey, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<TemplateCategory> GetCategoryAsync(string userKey, long categoryId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<TemplateCategoryVisibility[]> GetCategoryVisibilityAsync(string userKey, long categoryId, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<long> GetCategoryVisibilityCountAsync(string userKey, long categoryId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<long> GetCountAsync(string userKey, long? categoryId = default, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<Template[]> GetTemplatesAsync(string userKey, long? categoryId = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> SetCategoryVisibilityAsync(string userKey, long categoryId, IDictionary<long, bool> clientVisibility, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> UpdateAsync(string userKey, long templateId, IDictionary<string, string> labels, string content = null, long? categoryId = default, long? clientId = default, CancellationToken cancellationToken = default);
		...
		/// <param name="cancellationToken">The cancellation token</param>
		/// <returns>True if the category was updated</returns>
		Task<bool> UpdateCategoryAsync(string userKey, long categoryId, IDictionary<string, string> labels, bool isVisibleByDefault = true, bool templatesCanBeCopied = true, long? clientId = default, CancellationToken cancellationToken = default);
	}
}
