...
namespace CakeMail.RestClient.Resources
{
	...
	public interface IRelays
	{
		...
		Task<RelayBounceLog[]> GetBounceLogsAsync(string userKey, long? trackingId = default, DateTime? start = default, DateTime? end = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<RelayClickLog[]> GetClickLogsAsync(string userKey, long? trackingId = default, DateTime? start = default, DateTime? end = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<RelayOpenLog[]> GetOpenLogsAsync(string userKey, long? trackingId = default, DateTime? start = default, DateTime? end = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<RelayLog[]> GetSentLogsAsync(string userKey, long? trackingId = default, DateTime? start = default, DateTime? end = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> SendWithoutTrackingAsync(string userKey, string recipientEmailAddress, string subject, string html, string text, string senderEmail, string senderName = null, IDictionary<string, object> mergeData = null, MessageEncoding? encoding = default, long? clientId = default, CancellationToken cancellationToken = default);
		...
		/// <param name="cancellationToken">The cancellation token.</param>
		/// <returns>True if the email is sent.</returns>
		Task<bool> SendWithTrackingAsync(string userKey, long trackingId, string recipientEmailAddress, string subject, string html, string text, string senderEmail, string senderName = null, IDictionary<string, object> mergeData = null, MessageEncoding? encoding = default, long? clientId = default, CancellationToken cancellationToken = default);
	}
}
