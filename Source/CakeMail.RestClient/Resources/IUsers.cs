...
namespace CakeMail.RestClient.Resources
{
	...
	public interface IUsers
	{
		...
		Task<long> CreateAsync(string userKey, string email, string password, string firstName = null, string lastName = null, string title = null, string officePhone = null, string mobilePhone = null, string language = null, long timezoneId = 542, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> DeactivateAsync(string userKey, long userId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<bool> DeleteAsync(string userKey, long userId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<User> GetAsync(string userKey, long userId, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<long> GetCountAsync(string userKey, UserStatus? status = default, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<User[]> GetUsersAsync(string userKey, UserStatus? status = default, int? limit = 0, int? offset = 0, long? clientId = default, CancellationToken cancellationToken = default);
		...
		Task<LoginInfo> LoginAsync(string email, string password, long? clientId = default, CancellationToken cancellationToken = default);
